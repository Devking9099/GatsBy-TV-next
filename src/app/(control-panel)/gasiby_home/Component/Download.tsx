  ...
  return (
    <div className="bg-[linear-gradient(48deg,#8FCFFF_12.63%,#65BCFF_33.17%,#37A8FF_54.61%,#007EDE_101.94%)]  flex flex-col items-center justify-center px-52 pt-68 gap-16">
      <div className="flex flex-col items-center gap-32 self-stretch">
        <div className="text-gasbiprimarycolor-50 text-center text-5xl  normal-font">
        ...
        <div>
          ...
          <p className="text-center text-gasbiprimabrycolor-50 font-medium leading-normal opacity-[1.2]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="flex flex-col justify-center gap-[20px]">
          ...
          <div className="flex gap-12 mb-8">
            <Button className="w-full mt-32 px-20 py-32 text-2xl rounded-32 text-gasbiprimarycolor-50 bg-gasbiprimarycolor-800">
              Download for ios
            </Button>
            <Button className="w-full mt-32 px-20 py-32 text-2xl rounded-32 text-gasbiprimarycolor-50 bg-gasbiprimarycolor-800">
